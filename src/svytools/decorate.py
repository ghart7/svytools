...
# svytools libs
from svytools.genutils import ParamManager
from svytools.genplot import cbar_in_axes, get_contrast_color
...
def decorate_plot(ax: plt.Axes,
                  config: Dict,
                  plot_type: str,
                  **kwargs: Any) -> plt.Axes:
    """
    Applies a specific decoration to a plot's Axes object.
